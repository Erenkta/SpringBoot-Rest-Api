...
public class BookControllerIT { //IT == Integration Test yani birden fazla birimi aynı anda test etmek gibi
	...
	@Test
	public void testThatDeleteBookIsReturnsHTTP204WhenExistingBookIsDeleted() throws Exception{
		final BookDto book = TestData.testBookDto();
		bookService.create(book); // Oluşturduk şimdi silmesini deneyeceğiz
